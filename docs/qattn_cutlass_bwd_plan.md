...
|---:|---|---|---|
| 1 | Re-profile residual D64 Q/dO copy traffic | Do not port the D128 mirror by analogy: D64 already uses the retained lane-major packet handoff; reopen only if fresh source attribution finds a material residual copy family | Exact source attribution and fragment proof before any compiler screen |
